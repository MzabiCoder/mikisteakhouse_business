...
! function (st, ot, E) {
	...
	st.fn.simpleLightbox = function (N) {
		...
		var h, e, H = "ontouchstart" in ot,
			...
			U = !1,
			d = [],
			$ = N.rel && !1 !== N.rel ? (e = N.rel, st(this).filter(function () {
			...
			b = st("<div>").addClass("sl-wrapper").addClass(N.className),
			tt = function (o) {
				if (K.length) {
					var l = new Image,
			...
			C = function () {
				...
				var e, a, n, i, s, o, l, r, c, p, h, d, u, f, g, m, v, x, b, y, C, w, T, E, S, M, I, k = 0,
					q = 0,
					X = 0,
					D = 0,
					Y = !1,
				...
				_.on("touchstart." + G + " mousedown." + G, function (t) {
					...
					if ("mousedown" == (t = t.originalEvent).type) c = t.clientX, p = t.clientY, e = _.height(), a = _.width(), s = K.height(), o = K.width(), n = _.position().left, i = _.position().top, l = parseFloat(K.data("translate-x")), r = parseFloat(K.data("translate-y")), R = !0;
					else {
			...
			T = function (t) {
				...
				if ("hide" == t) {
					...
					if (E.body.clientWidth < a) {
						...
						i.className = "sl-scrollbar-measure", st("body").append(i), e = i.offsetWidth - i.clientWidth, st(E.body)[0].removeChild(i), st("body").data("padding", s), 0 < e && st("body").addClass("hidden-scroll").css({
							"padding-right": s + e
						})
					}
